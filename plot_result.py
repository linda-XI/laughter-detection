...
from visualise import plot_conf_matrix_laughVSnotlaugh
...
input_dir = 'eval/320/resnet18_small'
plot_conf_matrix_laughVSnotlaugh(input_dir,'test', name = 'small_laughVSnotlaugh', sub_dir = 'MINF2/laughVSnotlaugh')
