...
x1=[0.001563, 0.00315, 0.00609, 0.006183]
y1=[0.56, 0.55, 0.6, 0.6]
x2=[ 0.0042, 0.001063, 0.002702, 0.001433, 0.001175, 0.002094, 0.026296, 0.03346]
y2=[0.587, 0.59, 0.54, 0.551, 0.433, 0.455, 0.56, 0.557]
# x3=[30,50,70,90,105,114,128,137,147,159,170,180,190,200,210,230,243,259,284,297,311]
# y3=[48,48,48,48,66,173,351,472,586,712,804,899,994,1094,1198,1360,1458,1578,1734,1797,1892]
# x=np.arange(20,350)
l1=plt.plot(x1,y1,'r--',label='depth')
l2=plt.plot(x2,y2,'g--',label='rest')
